...
CREATE TABLE IF NOT EXISTS `excord`.`ec_requirement` (
  ...
  `story` TEXT NULL,
  PRIMARY KEY (`id`),
  INDEX `requirement_idx1` (`parent_id` ASC),
  UNIQUE INDEX `requirement_idx2` (`id` ASC, `parent_id` ASC),
...
CREATE TABLE IF NOT EXISTS `excord`.`ec_testcase_requirement_mapping` (
  ...
  PRIMARY KEY (`id`),
  INDEX `tc_req_mapping_fk_idx` (`requirement_id` ASC),
  INDEX `tc_req_mapping_fk2_idx` (`testcase_id` ASC),
